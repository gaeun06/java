...
public class MyClass {
    public static void main(String[] args) {
        ...
        System.out.println(kim.userName); // Kim
        ...
        Order order1 = new Order(100, kim, com,
                new Date(2025, Calendar.JUNE,24), 1);
        ...
        // 주문한 제품의 재고가 있는지 확인하려면?
        System.out.println(order1.product.stock); // 70

        /*
        주문 클래스의 필드인 주문자와 주문 제품은 User와 Product 클래스에
        강한 의존성을 가지소 있다.
        주문자와 주문 제품은 반드시  User 클래스와 Product 클래스의 객체여야 한다.
        이런 관계를 가지고 있는 필드의 경우에
        클래스 자체를 필드로 가지도록 주문 클래스를 설계할 필요가 있다.
        public class Order {
            User user; // 유저 이메일
            Product product;
        }
