...
public class ShiftOperator {
    public static void main(String[] args) {
        ...
        // 정밀한 나누기 계산이 필요한 곳에는 시프트 연산 대신 나누기를 사용해야 함!
        ...
        // 음수의 경우에는 왼쪽 자리를 1로 채우고
        // 양수의 경우에는 왼쪽 자리를 0으로 채운다.

        //  >>> 논리 시프트는 부호비트를 유지하지 않는 특징을 가지므로
        // 왼쪽 자리를 그냥 0으로 채운다
        System.out.println(-3 >>> 2); //
        // 11111111 11111111 11111111 11111101 = -3
        // 11111111 11111111 11111111 11111101 = 1,073,741,823

        // >> , << 의 산술 시프트와 >>> 논리 시프트는 왜 사용할까?
        // 1) 산술 시프트는 2의 제곱승의 계산에 자주 사용된다.
        // 2) 비트 마스크(bit mask)에 사용됨
        // 7654 3210 : 비트 위치
        // 1000 1001 : 137
        // 기계가 3번째 자리의 문이 열려 있는 지의 여부만 확인하고 싶을 때??
        // 1000 1001 = 137
        // 0000 1000 = mask
        // ------------------ & 연산
        // 0000 1000 = 마스크와 같은 값(즉, 0이 아닌 값)이 나오면 해당 위치가 1이라는 뜻
        int value = 137; //1000 1001
        int mask = 1 << 3; // 3번째 위치는 확인하기 위해 3을 시프트 연산함
        ...
        // boolean 타입에 비해 8배가 메모리 효율이 좋다 (==관리가 용이하다).
    }
}
